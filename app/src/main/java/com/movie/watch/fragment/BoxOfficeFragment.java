...
public class BoxOfficeFragment extends MovieSelectionFragment {
  ...
  public static Fragment create(String moviePath) {
    return BoxOfficeFragment_.builder().moviePath(moviePath).build();
  }
  ...
  public void onEventMainThread(BoxOfficeFetchEvent boxOfficeFetchEvent) {
    ...
    movieListAdapter.setMovies(boxOfficeFetchEvent.getMovies());
